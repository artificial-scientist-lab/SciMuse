...
Concept extraction and refinement code is maintained in the
[Impact4Cast repository](https://github.com/artificial-scientist-lab/Impact4Cast/tree/main/create_concepts).
The final concept list is included here in [`concept list/full_concepts.txt`](concept%20list/full_concepts.txt).
...
├── README.md
├── concept list/
│   └── full_concepts.txt                       # scientific concept list
├── figures/                                    # Images displayed in this README
│   ├── scimuse.jpeg
│   └── scimuse_benchmark_5k.png
├── graph_feature_plot/                         # Knowledge graph features vs. researcher ratings
│   ├── evaluation_feature_dataset.csv
│   ├── Fig4_features_interest_suggestion.py
│   ├── Fig4_features_impact_suggestion.py
│   └── Figures/
│       ├── Fig4_feature.png
│       └── Fig4_feature_impact_score_SI.png
├── human-ai-idea/                              # Human- and GPT-generated idea comparison
│   ├── 1_prompts_for_human/
│   │   └── questions_phd*.txt                  # prompts for PhD1–7
│   ├── 2_human_generate_ideas/
│   │   └── phd*_generated_idea.txt             # PhD1–7 generated ideas
│   ├── 3_gpt_generate_ideas/
│   │   └── phd*_gpt_generated_idea.txt         # GPT generated ideas
│   ├── 4_researcher_evaluation/
│   │   └── idea_rating_PI*.txt                 # Evaluators 1–6
│   └── 5_answers_plot_analysis/
│       ├── all_ratings_results.json
│       ├── plot_ratings_distribution.py
│       ├── rankings_distribution_all_three.png
│       ├── Fig6_rankings_distribution_all_three.pdf
│       └── distribution_interest_ratings_human_AI.png
├── hyperparameters/                           
│   ├── Fig_DecisionTree_hyperparameters/
│   │   ├── all_results_*.txt                  
│   │   └── plot_results.py
│   └── Fig_NN_hyperparameters/
│       ├── all_results_*_0.003.txt             
│       └── plot_results.py
└── interest_prediction/                       # Neural network, decision tree, and LLM comparisons
    ├── all_evaluation_data.pkl                 # MPG PI evaluation dataset
    ├── combined_ELO_results_35.txt             # ELO results for GPT-3.5
    ├── combined_ELO_results_4o.txt             # ELO results for GPT-40
    ├── combined_ELO_results_4omini.txt         # ELO results for GPT-40mini
    └── run_prediction_comparison.py            # Predicting scientific interest 
```
